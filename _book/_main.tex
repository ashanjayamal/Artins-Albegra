...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-107}{}\label{exr:unnamed-chunk-107}What are the possible values of \(a^2\) modulo 4? modulo 8?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-108}{}\label{exr:unnamed-chunk-108}Prove that every integer \(a\) is congruent to the sum of its decimal digits modulo 9.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-111}{}\label{exr:unnamed-chunk-111}Solve the congruence \(2x \equiv 5\) modulo 9 and modulo 6.
\end{exercise}

Done Later add.

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-112}{}\label{exr:unnamed-chunk-112}Determine the integers \(n\) for which the pair of congruences \(2x - y \equiv 1\) and \(4x + 3y \equiv 2\) modulo \(n\) has a solution.
\end{exercise}

Done Later add.

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-113}{}\label{exr:unnamed-chunk-113}Prove the Chinese Remainder Theorem: Let \(a, b, u, v\) be integers, and assume that the greatest common divisor of \(a\) and \(b\) is 1. Then there is an integer \(x\) such that \(x \equiv u\) modulo \(a\) and \(X \equiv v\) modulo \(b\).\\
Hint: Do the case \(u = 0\) and \(v = 1\) first.
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-114}{}\label{exr:unnamed-chunk-114}Determine the order of each of the matrices A and B when the matrix entries are interpreted modulo 3.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-115}{}\label{exr:unnamed-chunk-115}Let \(x\) be an element of order \(r\) of a group \(G\), and let \(y\) be an element of \(G'\) of order \(s\). What is the order of \((x, y)\) in the product group \(G \times G'\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-116}{}\label{exr:unnamed-chunk-116}What does Proposition \ref{prp:prp2114} tell us when, with the usual notation for the symmetric
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-117}{}\label{exr:unnamed-chunk-117}Prove that the product of two infinite cyclic groups is not infinite cyclic.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-120}{}\label{exr:unnamed-chunk-120}Let \(G_1\) and \(G_2\) be groups, and let \(Z_i\) be the center of \(G_i\). Prove that the center of the product group \(G_1 \times G_2\) is \(Z_1 \times Z_2\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-121}{}\label{exr:unnamed-chunk-121}Let \(G\) be a group that contains normal subgroups of orders \(3\) and \(5\), respectively. Prove that \(G\) contains an element of order \(15\).
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-122}{}\label{exr:unnamed-chunk-122}Let \(H\) be a subgroup of a group \(G\), let \(\phi:G \to H\) be a homomorphism whose restriction to \(H\) is the identity map, and let \(N\) be its kernel. What can one say about the product map \(H \times N \to G\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-123}{}\label{exr:unnamed-chunk-123}Let \(G\), \(G'\), and \(H\) be groups. Establish a bijective correspondence between homomorphisms \(\phi : H \to G \times G'\) from \(H\) to the product group and pairs \((\varphi, \varphi')\) consisting of a homomorphism \(\varphi:H \to G\) and a homomorphism \(\varphi':H \to G'\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-124}{}\label{exr:unnamed-chunk-124}Let \(H\) and \(K\) be subgroups of a group \(G\). Prove that the product set \(HK\) is a subgroup of \(G\) if and only if \(HK = KH\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-126}{}\label{exr:unnamed-chunk-126}Show that if a subgroup \(H\) of a group \(G\) is not normal, there are left cosets \(aH\) and \(bH\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-128}{}\label{exr:unnamed-chunk-128}In the general linear group \(GL_3(\mathbb{R})\), consider the subsets:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-129}{}\label{exr:unnamed-chunk-129}Let \(P\) be a partition of a group \(G\) with the property that for any pair of elements \(A\), \(B\) of the partition, the product set \(AB\) is contained entirely within another element \(C\) of the partition. Let \(N\) be the element of \(P\) that contains 1. Prove that \(N\) is a normal subgroup of \(G\) and that \(P\) is the set of its cosets.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-131}{}\label{exr:unnamed-chunk-131}Let \(H = \{\pm1, \pm i\}\) be the subgroup of \(G = C^{\times}\) of fourth roots of unity. Describe the cosets of \(H\) in \(G\) explicitly. Is \(G / H\) isomorphic to \(G\)?
\end{exercise}
...
\begin{exercise}[M1]
\protect\hypertarget{exr:unnamed-chunk-133}{}\label{exr:unnamed-chunk-133}Describe the column vectors \((a, c)^T\) that occur as the first column of an integer matrix \(A\) whose inverse is also an integer matrix.
\end{exercise}
...
\begin{exercise}[M.2]
\protect\hypertarget{exr:unnamed-chunk-134}{}\label{exr:unnamed-chunk-134}\leavevmode
