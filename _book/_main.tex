...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-15}{}\label{def:unnamed-chunk-15}Let \((G, *)\) and \((G', \odot)\) be groups. A \textbf{homomorphism} \(\phi: G \rightarrow G'\) is a map from \(G\) to \(G'\) such that for all \(a\) and \(b\) in \(G\):
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-16}{}\label{prp:unnamed-chunk-16}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-18}{}\label{def:unnamed-chunk-18}Sure, here is the LaTeX version of your statement:
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-19}{}\label{exm:unnamed-chunk-19}The two sets \emph{Even} and \emph{Odd} partition the set of integers.
\end{example}

\begin{example}
\protect\hypertarget{exm:unnamed-chunk-20}{}\label{exm:unnamed-chunk-20}With the usual notation, the sets
\[\{1\}, \{y, xy, x^2y\}, \{x, x^2\}\]
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-22}{}\label{exm:unnamed-chunk-22}Two triangles are said to be congruent if their sides have the same length and angles have same measure.\\
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-24}{}\label{prp:unnamed-chunk-24}An equivalence relation on a set S determines a partition of S, and conversely.
\end{proposition}
...
\begin{lemma}
\protect\hypertarget{lem:unnamed-chunk-26}{}\label{lem:unnamed-chunk-26}Given an equivalence relation on a set \(S\), the subsets of \(S\) that are equivalence classes partition \(S\).
\end{lemma}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-28}{}\label{exm:unnamed-chunk-28}If \(S\) is the set of integers and if \(\text{Even}\) and \(\text{Odd}\) denote the subsets of even and odd integers, respectively, then \(\overline{S}\) contains the two elements \([\text{Even}]\) and \([\text{Odd}]\).
\end{example}
...
\protect\hypertarget{def:unnamed-chunk-29}{}\label{def:unnamed-chunk-29}The inverse image of an element \(t\) of \(T\) is the subset of \(S\) consisting of all elements \(s\) such that \(f(s) = t\). It is denoted symbolically as
\begin{equation}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-31}{}\label{exm:unnamed-chunk-31}Let's consider the absolute value map from the complex numbers \(\mathbb{C}^\times\) to the positive real numbers \(\mathbb{R}^+\):
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-32}{}\label{exm:unnamed-chunk-32}If \(G\) is a finite group, we can define a map \(f : G \to \mathbb{N}\) to the set \(\{1, 2, 3, \ldots\}\) of natural numbers, letting \(f(a)\) be the order of the element \(a\) in \(G\). The fibers of this map are the sets of elements with the same order (see example \ref{exm:272}).
\end{example}

\includegraphics{figures/ch_2/fig34.png}

\begin{definition}[congruence]
\protect\hypertarget{def:unnamed-chunk-33}{}\label{def:unnamed-chunk-33}Let \(G,G'\) be a groups and \(\phi: G \rightarrow G'\) be a group group homomorphism. The equivalence relation on \(G\) defined by \(\phi\) is usually denoted by \(\equiv\), rather than by \(\sim\), and is referred to as congruence.
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-34}{}\label{prp:unnamed-chunk-34}Let \(K\) be the kernel of a homomorphism \(\varphi: G \to G'\). The fibre of that contains an element \(a\) of \(G\) is the coset \(a K\) of \(K\). These cosets partition the group \(G\), and they correspond to elements of the image of \(\varphi\).
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-36}{}\label{def:unnamed-chunk-36}Let \(\phi: G \rightarrow G^\prime\) be a group homomorphism, and let \(H\) be a subgroup of \(G\). We may restrict \(\phi\) to \(H\), obtaining a homomorphism
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-37}{}\label{exm:unnamed-chunk-37}Define sign homorphism \(\sigma: S_n \to \{\pm 1\}\) by \(\sigma(x)=1\) if \(x\) is even, and \(\sigma (x)=−1\) if \(x\) is odd. Then the image of the sign homomorphism is,
\[Im(\sigma)=\{\pm 1\}\]
it has order \(2\).
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-40}{}\label{exm:unnamed-chunk-40}let denote the determinant homomorphism \[det:GL_n(\mathbb{R})\to \mathbb{R}^\times\]. Note that \(\mathbb{R}^+\unlhd \mathbb{R}^\times\). (It is very clear that \$The set of positive real numbers is a subgroup of \(\mathbb{R}^\times\), and since \(\mathbb{R}^\times\) is abliean, \(\mathbb{R}^+\) is normal.) Now consider the inverse image of \(\mathbb{R}^+\),
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-42}{}\label{exm:unnamed-chunk-42}Recall
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-44}{}\label{exm:unnamed-chunk-44}Consider a cyclicgroup of order \(6\) can be decomposed. It migheted be suprised you. A cyclic group \(C_6\) of order \(6\) isisomorphic to the product \(C_2 \times C_3\) of cyclic groups of orders \(2\) and \(3\).
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-45}{}\label{prp:unnamed-chunk-45}Let \(r\) and \(s\) be relatively prime integers.
A cyclic group of order \(rs\) is isomorphic to the product of a cyclic group of order \(r\) and a cyclic group of order \(s\).
\end{proposition}

\begin{example}[s]
\protect\hypertarget{exm:unnamed-chunk-46}{}\label{exm:unnamed-chunk-46}On the other hand, a cyclic group of order \(4\) is not isomorphic to a product of two cyclic
groups of order \(2\).
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-48}{}\label{prp:unnamed-chunk-48}There are two isomorphism classes of groups of order \(4\), the class of the cyclic group \(C_4\) of order \(4\) and the class of the Klein Four Group,which is isomorphic to the product \(C_2 \times C_2\) of two groups of order \(2\).
\end{proposition}
...
\begin{definition}
\protect\hypertarget{def:unnamed-chunk-50}{}\label{def:unnamed-chunk-50}The set of cosets of a normal subgroup \(N\) of a group \(G\) is often denoted by \(G / N\).
...
\begin{corollary}
\protect\hypertarget{cor:unnamed-chunk-52}{}\label{cor:unnamed-chunk-52}Let \(N \trianglelefteq G\), and let \(\overline{G}\) denote the set of cosets of \(N\) in \(G\). Let \(\pi: G \to \overline{G}=G/N\) be the canonical homomorphism. Let \(a_1, \ldots, a_k\in G\) such that the product \(a_1 \cdots a_k\in N\). Then \(\overline{a_1} \cdots \overline{a_k} = \overline{1}\).
\end{corollary}
...
\begin{lemma}
\protect\hypertarget{lem:unnamed-chunk-56}{}\label{lem:unnamed-chunk-56}Let \(G\) be a group, and let \(Y\) be a set with a law of composition (both laws written with multiplicative notation). Consider a surjective map \(\varphi : G \to Y\) with the homomorphism property: \(\varphi(ab) = \varphi(a)\varphi(b)\) for all \(a\) and \(b\) in \(G\). Then \(Y\) is a group, and \(\varphi\) is a homomorphism.
\end{lemma}
...
\protect\hypertarget{thm:unnamed-chunk-59}{}\label{thm:unnamed-chunk-59}Let \(\varphi: G \to G'\) be a surjective group homomorphism with kernel \(N\). The quotient group \(\overline{G}=G/N\) is isomorphic to the image \(G'\). To be precise, let \(\pi: G \to \overline{G}=G/N\) be the canonical map. There exists a unique isomorphism \(\overline{\varphi}: G/N \to G'\) such that \(\varphi = \psi \circ \pi\).
\end{theorem}
...
\begin{corollary}
\protect\hypertarget{cor:unnamed-chunk-61}{}\label{cor:unnamed-chunk-61}Let \(\varphi: G \rightarrow G'\) be a group homomorphism with kernel \(N\) and image \(H'\). The quotient group \(\overline{G}=G/N\) is isomorphic to the image \(H'\).
\end{corollary}
...
\protect\hypertarget{exr:unnamed-chunk-62}{}\label{exr:unnamed-chunk-62}Let \(S\) be a set. Prove that the law of composition defined by \(ab = a\) for all \(a\) and \(b\) in \(S\) is associative? For which sets does this law have an identity?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-63}{}\label{exr:unnamed-chunk-63}Prove the properties of inversesthat are listed near the end ofthe section.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-67}{}\label{exr:unnamed-chunk-67}Make a multiplication table for the symmetric group \(S_3\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-68}{}\label{exr:unnamed-chunk-68}Let \(S\) be a se t with an associative law of composition and with an identity element. Prove that the subset consisting of the invertible elements in \(S\) is a group.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-75}{}\label{exr:unnamed-chunk-75}Let \(G\) be a group. We define an opposite group \(G^{\circ}\) with the law of composition \(a * b\) as follows:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-76}{}\label{exr:unnamed-chunk-76}Let \(a = 123\) and \(b = 321\).
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-77}{}\label{exr:unnamed-chunk-77}Prove that if \(a\) and \(b\) are positive integers whose sum is a prime \(p\), their greatest common
divisor is \(1\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-78}{}\label{exr:unnamed-chunk-78}Define the greatest common divisor of a set \(\{a_1, ..., a_n\}\) of \(n\) integers. Prove that it
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-79}{}\label{exr:unnamed-chunk-79}Let \(a\) and \(b\) be elements of a group \(G\). Assume that a has order \(7\) and that \(a^3b = ba^3\).
Prove that \(a b = ba\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-81}{}\label{exr:unnamed-chunk-81}Let \(a\) and \(b\) be elements of a group \(G\). Prove that \(ab\) and \(ba\) have the same order
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-83}{}\label{exr:unnamed-chunk-83}What are the possible values of \(a^2\) modulo 4? modulo 8?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-84}{}\label{exr:unnamed-chunk-84}Prove that every integer \(a\) is congruent to the sum of its decimal digits modulo 9.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-87}{}\label{exr:unnamed-chunk-87}Solve the congruence \(2x \equiv 5\) modulo 9 and modulo 6.
\end{exercise}

Done Later add.

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-88}{}\label{exr:unnamed-chunk-88}Determine the integers \(n\) for which the pair of congruences \(2x - y \equiv 1\) and \(4x + 3y \equiv 2\) modulo \(n\) has a solution.
\end{exercise}

Done Later add.

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-89}{}\label{exr:unnamed-chunk-89}Prove the Chinese Remainder Theorem: Let \(a, b, u, v\) be integers, and assume that the greatest common divisor of \(a\) and \(b\) is 1. Then there is an integer \(x\) such that \(x \equiv u\) modulo \(a\) and \(X \equiv v\) modulo \(b\).\\
Hint: Do the case \(u = 0\) and \(v = 1\) first.
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-90}{}\label{exr:unnamed-chunk-90}Determine the order of each of the matrices A and B when the matrix entries are interpreted modulo 3.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-91}{}\label{exr:unnamed-chunk-91}Let \(x\) be an element of order \(r\) of a group \(G\), and let \(y\) be an element of \(G'\) of order \(s\). What is the order of \((x, y)\) in the product group \(G \times G'\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-92}{}\label{exr:unnamed-chunk-92}What does Proposition \ref{prp:prp2114} tell us when, with the usual notation for the symmetric
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-93}{}\label{exr:unnamed-chunk-93}Prove that the product of two infinite cyclic groups is not infinite cyclic.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-96}{}\label{exr:unnamed-chunk-96}Let \(G_1\) and \(G_2\) be groups, and let \(Z_i\) be the center of \(G_i\). Prove that the center of the product group \(G_1 \times G_2\) is \(Z_1 \times Z_2\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-97}{}\label{exr:unnamed-chunk-97}Let \(G\) be a group that contains normal subgroups of orders \(3\) and \(5\), respectively. Prove that \(G\) contains an element of order \(15\).
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-98}{}\label{exr:unnamed-chunk-98}Let \(H\) be a subgroup of a group \(G\), let \(\phi:G \to H\) be a homomorphism whose restriction to \(H\) is the identity map, and let \(N\) be its kernel. What can one say about the product map \(H \times N \to G\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-99}{}\label{exr:unnamed-chunk-99}Let \(G\), \(G'\), and \(H\) be groups. Establish a bijective correspondence between homomorphisms \(\phi : H \to G \times G'\) from \(H\) to the product group and pairs \((\varphi, \varphi')\) consisting of a homomorphism \(\varphi:H \to G\) and a homomorphism \(\varphi':H \to G'\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-100}{}\label{exr:unnamed-chunk-100}Let \(H\) and \(K\) be subgroups of a group \(G\). Prove that the product set \(HK\) is a subgroup of \(G\) if and only if \(HK = KH\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-102}{}\label{exr:unnamed-chunk-102}Show that if a subgroup \(H\) of a group \(G\) is not normal, there are left cosets \(aH\) and \(bH\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-104}{}\label{exr:unnamed-chunk-104}In the general linear group \(GL_3(\mathbb{R})\), consider the subsets:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-105}{}\label{exr:unnamed-chunk-105}Let \(P\) be a partition of a group \(G\) with the property that for any pair of elements \(A\), \(B\) of the partition, the product set \(AB\) is contained entirely within another element \(C\) of the partition. Let \(N\) be the element of \(P\) that contains 1. Prove that \(N\) is a normal subgroup of \(G\) and that \(P\) is the set of its cosets.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-107}{}\label{exr:unnamed-chunk-107}Let \(H = \{\pm1, \pm i\}\) be the subgroup of \(G = C^{\times}\) of fourth roots of unity. Describe the cosets of \(H\) in \(G\) explicitly. Is \(G / H\) isomorphic to \(G\)?
\end{exercise}
...
\begin{exercise}[M1]
\protect\hypertarget{exr:unnamed-chunk-109}{}\label{exr:unnamed-chunk-109}Describe the column vectors \((a, c)^T\) that occur as the first column of an integer matrix \(A\) whose inverse is also an integer matrix.
\end{exercise}
...
\begin{exercise}[M.2]
\protect\hypertarget{exr:unnamed-chunk-110}{}\label{exr:unnamed-chunk-110}\leavevmode
