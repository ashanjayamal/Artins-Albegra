...
\protect\hypertarget{exr:unnamed-chunk-133}{}\label{exr:unnamed-chunk-133}Prove that in a group, the products \(ab\) and \(ba\) are conjugate elements.
\end{exercise}

\includegraphics{figures/ch_2/fig82.png}

\begin{exercise}[Artin 2.6.5]
\protect\hypertarget{exr:unnamed-chunk-135}{}\label{exr:unnamed-chunk-135}Decide whether or not the two matrices \(A = \begin{bmatrix} 3 & 0 \\ 0 & 2 \end{bmatrix}\) and \(B = \begin{bmatrix} 1 & 1 \\ -2 & 4 \end{bmatrix}\) are conjugate elements of the general linear group \(GL_2(\mathbb{R})\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-140}{}\label{exr:unnamed-chunk-140}Let \(H\) be a subgroup of \(G\), and let \(g\) be a fixed element of \(G\). The conjugate subgroup \(gHg^{-1}\) is defined to be the set of all conjugates \(ghg^{-1}\), with \(h\) in \(H\). Prove that \(gHg^{-1}\) is a subgroup of \(G\).
\end{exercise}

\includegraphics{figures/ch_2/fig87.png}

\begin{exercise}[Artin 2.6.8]
\protect\hypertarget{exr:unnamed-chunk-142}{}\label{exr:unnamed-chunk-142}Prove that the map \(A \mapsto (A^{t})^{-1}\) is an automorphism of \(GL_{n}(\mathbb{R})\).
\end{exercise}

\includegraphics{figures/ch_2/fig88.png}

\begin{exercise}[Artin 2.6.9]
\protect\hypertarget{exr:unnamed-chunk-144}{}\label{exr:unnamed-chunk-144}Prove that a group \(G\) and its opposite group \(G^{o}\) (Exercise 2.2.6) are isomorphic.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-148}{}\label{exr:unnamed-chunk-148}Let \(a\) be an element of a group \(G\). Prove that if the set \(\{1, a\}\) is a normal subgroup of \(G\), then \(a\) is in the center of \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-150}{}\label{exr:unnamed-chunk-150}Let \(G\) be a group. Prove that the relation \(a \sim b\) if \(b = gag^{-1}\) for some \(g\) in \(G\) is an equivalence relation on \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-153}{}\label{exr:unnamed-chunk-153}An equivalence relation on \(S\) is determined by the subset \(R\) of the set \(S \times S\) consisting of those pairs \((a, b)\) such that \(a \sim b\). Write the axioms for an equivalence relation in terms of the subset \(R\).
\end{exercise}

\includegraphics{figures/ch_2/fig94.png}

\begin{exercise}[Artin 2.7.3]
\protect\hypertarget{exr:unnamed-chunk-155}{}\label{exr:unnamed-chunk-155}With the notation of Exercise 2.7.2, is the intersection \(R \cap R'\) of two equivalence relations \(R\) and \(R'\) an equivalence relation? Is the union?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-158}{}\label{exr:unnamed-chunk-158}A relation \(R\) on the set of real numbers can be thought of as a subset of the \((x, y)\)-plane. With the notation of Exercise 7.2, explain the geometric meaning of the reflexive and symmetric properties.
\end{exercise}
...
\begin{exercise}[Artin 2.7.5]
\protect\hypertarget{exr:unnamed-chunk-162}{}\label{exr:unnamed-chunk-162}How many different equivalence relations can be defined on a set of five elements?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-165}{}\label{exr:unnamed-chunk-165}Let \(H\) be the cyclic subgroup of the alternating group \(A_4\) generated by the permutation \((123)\). Exhibit the left and the right cosets of \(H\) explicitly.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-169}{}\label{exr:unnamed-chunk-169}A finite group contains an element \(x\) of order \(10\) and also an element \(y\) of order \(6\). What can be said about the order of \(G\)?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-170}{}\label{exr:unnamed-chunk-170}Let \(\phi: G \rightarrow G'\) be a group homomorphism. Suppose that \(|G| = 18\), \(|G'| = 15\), and that \(\phi\) is not the trivial homomorphism. What is the order of the kernel?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-171}{}\label{exr:unnamed-chunk-171}A group \(G\) of order 22 contains elements \(x\) and \(y\), where \(x \neq 1\) and \(y\) is not a power of \(x\). Prove that the subgroup generated by these elements is the whole group \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-173}{}\label{exr:unnamed-chunk-173}Let \(G\) be a group of order \(25\). Prove that \(G\) has at least one subgroup of order \(5\), and that if it contains only one subgroup of order \(5\), then it is a cyclic group.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-176}{}\label{exr:unnamed-chunk-176}Let \(G\) be a finite group. Under what circumstances is the map \(f: G \to G\) defined by \(f(x) = x^2\) an automorphism of \(G\)?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-179}{}\label{exr:unnamed-chunk-179}Prove that every subgroup of index \(2\) is a normal subgroup, and show by example that a subgroup of index \(3\) need not be normal.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-181}{}\label{exr:unnamed-chunk-181}Let \(G\) and \(H\) be the following subgroups of \(GL_2 (\mathbb{R})\):
...
\protect\hypertarget{exr:unnamed-chunk-182}{}\label{exr:unnamed-chunk-182}Let \(S\) be a subset of a group \(G\) that contains the identity element 1, and such that the left cosets \(aS\), with \(a\) in \(G\), partition \(G\). Prove that \(S\) is a subgroup of \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-185}{}\label{exr:unnamed-chunk-185}What are the possible values of \(a^2\) modulo 4? modulo 8?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-186}{}\label{exr:unnamed-chunk-186}Prove that every integer \(a\) is congruent to the sum of its decimal digits modulo 9.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-189}{}\label{exr:unnamed-chunk-189}Solve the congruence \(2x \equiv 5\) modulo 9 and modulo 6.
\end{exercise}

\includegraphics{figures/ch_2/fig102.jpg}

\begin{exercise}[Artin 2.9.5]
\protect\hypertarget{exr:unnamed-chunk-191}{}\label{exr:unnamed-chunk-191}Determine the integers \(n\) for which the pair of congruences \(2x - y \equiv 1\) and \(4x + 3y \equiv 2\) modulo \(n\) has a solution.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-194}{}\label{exr:unnamed-chunk-194}Prove the Chinese Remainder Theorem: Let \(a, b, u, v\) be integers, and assume that the greatest common divisor of \(a\) and \(b\) is 1. Then there is an integer \(x\) such that \(x \equiv u\) modulo \(a\) and \(X \equiv v\) modulo \(b\).\\
Hint: Do the case \(u = 0\) and \(v = 1\) first.
\end{exercise}

\begin{exercise}[Artin 2.9.7]
\protect\hypertarget{exr:unnamed-chunk-195}{}\label{exr:unnamed-chunk-195}Determine the order of each of the matrices \(A=\begin{bmatrix}1 & 1 \\ 0 & 1\end{bmatrix}\) and \(B=\begin{bmatrix}1 & 1 \\ 1 & 0\end{bmatrix}\) when the matrix entries are interpreted modulo 3.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-197}{}\label{exr:unnamed-chunk-197}Describe how to tell from the cycle decomposition whether a permutation is odd or even.
\end{exercise}

\begin{exercise}[Artin 2.10.2]
\protect\hypertarget{exr:unnamed-chunk-198}{}\label{exr:unnamed-chunk-198}Let H and K be subgroups of a group G.
...
\protect\hypertarget{exr:unnamed-chunk-199}{}\label{exr:unnamed-chunk-199}Let \(G\) and \(G'\) be cyclic groups of orders \(12\) and \(6\), generated by elements \(x\) and \(y\), respectively, and let \(\phi : G \to G'\) be the map defined by \(\phi(x^i) = y^i\). Exhibit the correspondence referred to in the Correspondence Theorem explicitly.
\end{exercise}

\begin{exercise}[Artin 2.10.4]
\protect\hypertarget{exr:unnamed-chunk-200}{}\label{exr:unnamed-chunk-200}With the notation of the Correspondence Theorem, let \(H\) and \(H'\) be corresponding subgroups. Prove that \[[G : H] = [G' : H']\].
\end{exercise}

\begin{exercise}[Artin 2.10.5]
\protect\hypertarget{exr:unnamed-chunk-201}{}\label{exr:unnamed-chunk-201}With reference to the homomorphism S4 -\textgreater{} S3 described in Example 2.5.13, determine the six subgroups of S4 that contain K.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-202}{}\label{exr:unnamed-chunk-202}Let \(x\) be an element of order \(r\) of a group \(G\), and let \(y\) be an element of \(G'\) of order \(s\). What is the order of \((x, y)\) in the product group \(G \times G'\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-203}{}\label{exr:unnamed-chunk-203}What does Proposition \ref{prp:prp2114} tell us when, with the usual notation for the symmetric
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-204}{}\label{exr:unnamed-chunk-204}Prove that the product of two infinite cyclic groups is not infinite cyclic.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-207}{}\label{exr:unnamed-chunk-207}Let \(G_1\) and \(G_2\) be groups, and let \(Z_i\) be the center of \(G_i\). Prove that the center of the product group \(G_1 \times G_2\) is \(Z_1 \times Z_2\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-208}{}\label{exr:unnamed-chunk-208}Let \(G\) be a group that contains normal subgroups of orders \(3\) and \(5\), respectively. Prove that \(G\) contains an element of order \(15\).
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-209}{}\label{exr:unnamed-chunk-209}Let \(H\) be a subgroup of a group \(G\), let \(\phi:G \to H\) be a homomorphism whose restriction to \(H\) is the identity map, and let \(N\) be its kernel. What can one say about the product map \(H \times N \to G\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-210}{}\label{exr:unnamed-chunk-210}Let \(G\), \(G'\), and \(H\) be groups. Establish a bijective correspondence between homomorphisms \(\phi : H \to G \times G'\) from \(H\) to the product group and pairs \((\varphi, \varphi')\) consisting of a homomorphism \(\varphi:H \to G\) and a homomorphism \(\varphi':H \to G'\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-211}{}\label{exr:unnamed-chunk-211}Let \(H\) and \(K\) be subgroups of a group \(G\). Prove that the product set \(HK\) is a subgroup of \(G\) if and only if \(HK = KH\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-213}{}\label{exr:unnamed-chunk-213}Show that if a subgroup \(H\) of a group \(G\) is not normal, there are left cosets \(aH\) and \(bH\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-215}{}\label{exr:unnamed-chunk-215}In the general linear group \(GL_3(\mathbb{R})\), consider the subsets:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-216}{}\label{exr:unnamed-chunk-216}Let \(P\) be a partition of a group \(G\) with the property that for any pair of elements \(A\), \(B\) of the partition, the product set \(AB\) is contained entirely within another element \(C\) of the partition. Let \(N\) be the element of \(P\) that contains 1. Prove that \(N\) is a normal subgroup of \(G\) and that \(P\) is the set of its cosets.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-218}{}\label{exr:unnamed-chunk-218}Let \(H = \{\pm1, \pm i\}\) be the subgroup of \(G = C^{\times}\) of fourth roots of unity. Describe the cosets of \(H\) in \(G\) explicitly. Is \(G / H\) isomorphic to \(G\)?
\end{exercise}
...
\begin{exercise}[M1]
\protect\hypertarget{exr:unnamed-chunk-220}{}\label{exr:unnamed-chunk-220}Describe the column vectors \((a, c)^T\) that occur as the first column of an integer matrix \(A\) whose inverse is also an integer matrix.
\end{exercise}
...
\begin{exercise}[M.2]
\protect\hypertarget{exr:unnamed-chunk-221}{}\label{exr:unnamed-chunk-221}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-223}{}\label{exr:unnamed-chunk-223}(Double Cosets) Let \(H\) and \(K\) be subgroups of a group \(G\), and let \(g\) be an element of \(G\). \textbackslash{}
