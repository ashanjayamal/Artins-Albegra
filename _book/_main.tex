...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-152}{}\label{exr:unnamed-chunk-152}Let \(G_1\) and \(G_2\) be groups, and let \(Z_i\) be the center of \(G_i\). Prove that the center of the product group \(G_1 \times G_2\) is \(Z_1 \times Z_2\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-153}{}\label{exr:unnamed-chunk-153}Let \(G\) be a group that contains normal subgroups of orders \(3\) and \(5\), respectively. Prove that \(G\) contains an element of order \(15\).
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-154}{}\label{exr:unnamed-chunk-154}Let \(H\) be a subgroup of a group \(G\), let \(\phi:G \to H\) be a homomorphism whose restriction to \(H\) is the identity map, and let \(N\) be its kernel. What can one say about the product map \(H \times N \to G\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-155}{}\label{exr:unnamed-chunk-155}Let \(G\), \(G'\), and \(H\) be groups. Establish a bijective correspondence between homomorphisms \(\phi : H \to G \times G'\) from \(H\) to the product group and pairs \((\varphi, \varphi')\) consisting of a homomorphism \(\varphi:H \to G\) and a homomorphism \(\varphi':H \to G'\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-156}{}\label{exr:unnamed-chunk-156}Let \(H\) and \(K\) be subgroups of a group \(G\). Prove that the product set \(HK\) is a subgroup of \(G\) if and only if \(HK = KH\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-158}{}\label{exr:unnamed-chunk-158}Show that if a subgroup \(H\) of a group \(G\) is not normal, there are left cosets \(aH\) and \(bH\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-160}{}\label{exr:unnamed-chunk-160}In the general linear group \(GL_3(\mathbb{R})\), consider the subsets:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-161}{}\label{exr:unnamed-chunk-161}Let \(P\) be a partition of a group \(G\) with the property that for any pair of elements \(A\), \(B\) of the partition, the product set \(AB\) is contained entirely within another element \(C\) of the partition. Let \(N\) be the element of \(P\) that contains 1. Prove that \(N\) is a normal subgroup of \(G\) and that \(P\) is the set of its cosets.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-163}{}\label{exr:unnamed-chunk-163}Let \(H = \{\pm1, \pm i\}\) be the subgroup of \(G = C^{\times}\) of fourth roots of unity. Describe the cosets of \(H\) in \(G\) explicitly. Is \(G / H\) isomorphic to \(G\)?
\end{exercise}
...
\begin{exercise}[M1]
\protect\hypertarget{exr:unnamed-chunk-165}{}\label{exr:unnamed-chunk-165}Describe the column vectors \((a, c)^T\) that occur as the first column of an integer matrix \(A\) whose inverse is also an integer matrix.
\end{exercise}
...
\begin{exercise}[M.2]
\protect\hypertarget{exr:unnamed-chunk-166}{}\label{exr:unnamed-chunk-166}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-168}{}\label{exr:unnamed-chunk-168}(Double Cosets) Let \(H\) and \(K\) be subgroups of a group \(G\), and let \(g\) be an element of \(G\). \textbackslash{}
