...
\protect\hypertarget{exr:unnamed-chunk-91}{}\label{exr:unnamed-chunk-91}Let \(G\) be a group. We define an opposite group \(G^{\circ}\) with the law of composition \(a * b\) as follows:
...
\protect\hypertarget{exr:unnamed-chunk-92}{}\label{exr:unnamed-chunk-92}Let \(a = 123\) and \(b = 321\).
...
\protect\hypertarget{exr:unnamed-chunk-93}{}\label{exr:unnamed-chunk-93}Prove that if \(a\) and \(b\) are positive integers whose sum is a prime \(p\), their greatest common
divisor is \(1\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-94}{}\label{exr:unnamed-chunk-94}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-98}{}\label{exr:unnamed-chunk-98}Let \(a\) and \(b\) be elements of a group \(G\). Assume that a has order \(7\) and that \(a^3b = ba^3\).
Prove that \(a b = ba\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-100}{}\label{exr:unnamed-chunk-100}Let \(a\) and \(b\) be elements of a group \(G\). Prove that \(ab\) and \(ba\) have the same order
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-102}{}\label{exr:unnamed-chunk-102}Describe all groups G that contain no proper subgroup
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-108}{}\label{exr:unnamed-chunk-108}Prove that every subgroup of a cyclic group is cyclic. Do this by working with exponents, and use the description of the subgroups of \((\mathbb{Z},+)\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-111}{}\label{exr:unnamed-chunk-111}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-115}{}\label{exr:unnamed-chunk-115}Let \(x\) and \(y\) be elements of a group \(G\). Assume that each of the elements \(x\), \(y\), and \(xy\) has order 2. Prove that the set \(H = \{I, x, y, xy\}\) is a subgroup of \(G\), and that it has order 4.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-119}{}\label{exr:unnamed-chunk-119}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-121}{}\label{exr:unnamed-chunk-121}How many elements of order \(2\) does the symmetric group \(S_4\) contain?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-125}{}\label{exr:unnamed-chunk-125}Show by example that the product of elementsof finite order in a group need not have finite order. What if the group is abelian?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-128}{}\label{exr:unnamed-chunk-128}Let \(\varphi: G \rightarrow G'\) be a surjective homomorphism. Prove that if \(G\) is cyclic, then \(G'\) is cyclic, and if \(G\) is abelian, then \(G'\) is abelian.
\end{exercise}

\includegraphics{figures/ch_2/fig73.png}

\begin{exercise}[Artin 2.5.2]
\protect\hypertarget{exr:unnamed-chunk-130}{}\label{exr:unnamed-chunk-130}Prove that the intersection \(K \cap H\) ofsubgroupsof a group \(G\) is a subgroup of \(H\), and that if \(K\) is a normal subgroup of \(G\), then \(K \cap H\) is a normal subgroup of \(H\).
\end{exercise}

\includegraphics{figures/ch_2/fig74.png}

\begin{exercise}[Artin 2.5.3]
\protect\hypertarget{exr:unnamed-chunk-132}{}\label{exr:unnamed-chunk-132}Let \(U\) denote the group of invertible upper triangular \(2 \times 2\) matrices \(A = \begin{bmatrix} a & b \\ 0 & d \end{bmatrix}\), and let \(\varphi : U \rightarrow \mathbb{R}^{\times}\) be the map that sends \(A\) to \(a^2\). Prove that \(\varphi\) is a homomorphism, and determine its kernel and image.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-135}{}\label{exr:unnamed-chunk-135}Let \(f: (\mathbb{R},+) \rightarrow (\mathbb{C},\times)\) be the map \(f(x) = e^{ix}\). Prove that \(f\) is a homomorphism, and determine its kernel and image.
\end{exercise}

\includegraphics{figures/ch_2/fig77.png}

\begin{exercise}[Artin 2.5.5]
\protect\hypertarget{exr:unnamed-chunk-137}{}\label{exr:unnamed-chunk-137}Prove that the \(n \times n\) matrices that have the block form \(M = \begin{bmatrix} A & B \\ 0 & D \end{bmatrix}\), with \(A \in GL_r(\mathbb{R})\) and \(D \in GL_{n-r}(\mathbb{R})\), form a subgroup \(H\) of \(GL_n(\mathbb{R})\), and that the map \(H \rightarrow GL_r(\mathbb{R})\) that sends \(M \mapsto A\) is a homomorphism. What is its kernel?
\end{exercise}

\begin{exercise}[Artin 2.5.6]
\protect\hypertarget{exr:unnamed-chunk-138}{}\label{exr:unnamed-chunk-138}Determine the center of \(GL_n (\mathbb{R})\).
...
\protect\hypertarget{exr:unnamed-chunk-139}{}\label{exr:unnamed-chunk-139}Let \(G'\) be the group of real matrices of the form
...
\protect\hypertarget{exr:unnamed-chunk-141}{}\label{exr:unnamed-chunk-141}Describe all homomorphisms \(\phi : (\mathbb{Z},+) \rightarrow (\mathbb{Z},+)\). Determine which are injective, which are surjective, and which are isomorphisms.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-145}{}\label{exr:unnamed-chunk-145}Show that the functions \(f = \frac{1}{x}\), \(g = \frac{x - 1}{x}\) generate a group of functions, the law of composition being composition of functions, that is isomorphic to the symmetric group \(S_3\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-147}{}\label{exr:unnamed-chunk-147}Prove that in a group, the products \(ab\) and \(ba\) are conjugate elements.
\end{exercise}

\includegraphics{figures/ch_2/fig82.png}

\begin{exercise}[Artin 2.6.5]
\protect\hypertarget{exr:unnamed-chunk-149}{}\label{exr:unnamed-chunk-149}Decide whether or not the two matrices \(A = \begin{bmatrix} 3 & 0 \\ 0 & 2 \end{bmatrix}\) and \(B = \begin{bmatrix} 1 & 1 \\ -2 & 4 \end{bmatrix}\) are conjugate elements of the general linear group \(GL_2(\mathbb{R})\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-154}{}\label{exr:unnamed-chunk-154}Let \(H\) be a subgroup of \(G\), and let \(g\) be a fixed element of \(G\). The conjugate subgroup \(gHg^{-1}\) is defined to be the set of all conjugates \(ghg^{-1}\), with \(h\) in \(H\). Prove that \(gHg^{-1}\) is a subgroup of \(G\).
\end{exercise}

\includegraphics{figures/ch_2/fig87.png}

\begin{exercise}[Artin 2.6.8]
\protect\hypertarget{exr:unnamed-chunk-156}{}\label{exr:unnamed-chunk-156}Prove that the map \(A \mapsto (A^{t})^{-1}\) is an automorphism of \(GL_{n}(\mathbb{R})\).
\end{exercise}

\includegraphics{figures/ch_2/fig88.png}

\begin{exercise}[Artin 2.6.9]
\protect\hypertarget{exr:unnamed-chunk-158}{}\label{exr:unnamed-chunk-158}Prove that a group \(G\) and its opposite group \(G^{o}\) (Exercise 2.2.6) are isomorphic.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-162}{}\label{exr:unnamed-chunk-162}Let \(a\) be an element of a group \(G\). Prove that if the set \(\{1, a\}\) is a normal subgroup of \(G\), then \(a\) is in the center of \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-164}{}\label{exr:unnamed-chunk-164}Let \(G\) be a group. Prove that the relation \(a \sim b\) if \(b = gag^{-1}\) for some \(g\) in \(G\) is an equivalence relation on \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-167}{}\label{exr:unnamed-chunk-167}An equivalence relation on \(S\) is determined by the subset \(R\) of the set \(S \times S\) consisting of those pairs \((a, b)\) such that \(a \sim b\). Write the axioms for an equivalence relation in terms of the subset \(R\).
\end{exercise}

\includegraphics{figures/ch_2/fig94.png}

\begin{exercise}[Artin 2.7.3]
\protect\hypertarget{exr:unnamed-chunk-169}{}\label{exr:unnamed-chunk-169}With the notation of Exercise 2.7.2, is the intersection \(R \cap R'\) of two equivalence relations \(R\) and \(R'\) an equivalence relation? Is the union?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-172}{}\label{exr:unnamed-chunk-172}A relation \(R\) on the set of real numbers can be thought of as a subset of the \((x, y)\)-plane. With the notation of Exercise 7.2, explain the geometric meaning of the reflexive and symmetric properties.
\end{exercise}
...
\begin{exercise}[Artin 2.7.5]
\protect\hypertarget{exr:unnamed-chunk-176}{}\label{exr:unnamed-chunk-176}How many different equivalence relations can be defined on a set of five elements?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-179}{}\label{exr:unnamed-chunk-179}Let \(H\) be the cyclic subgroup of the alternating group \(A_4\) generated by the permutation \((123)\). Exhibit the left and the right cosets of \(H\) explicitly.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-185}{}\label{exr:unnamed-chunk-185}A finite group contains an element \(x\) of order \(10\) and also an element \(y\) of order \(6\). What can be said about the order of \(G\)?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-186}{}\label{exr:unnamed-chunk-186}Let \(\phi: G \rightarrow G'\) be a group homomorphism. Suppose that \(|G| = 18\), \(|G'| = 15\), and that \(\phi\) is not the trivial homomorphism. What is the order of the kernel?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-187}{}\label{exr:unnamed-chunk-187}A group \(G\) of order 22 contains elements \(x\) and \(y\), where \(x \neq 1\) and \(y\) is not a power of \(x\). Prove that the subgroup generated by these elements is the whole group \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-189}{}\label{exr:unnamed-chunk-189}Let \(G\) be a group of order \(25\). Prove that \(G\) has at least one subgroup of order \(5\), and that if it contains only one subgroup of order \(5\), then it is a cyclic group.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-192}{}\label{exr:unnamed-chunk-192}Let \(G\) be a finite group. Under what circumstances is the map \(f: G \to G\) defined by \(f(x) = x^2\) an automorphism of \(G\)?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-195}{}\label{exr:unnamed-chunk-195}Prove that every subgroup of index \(2\) is a normal subgroup, and show by example that a subgroup of index \(3\) need not be normal.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-197}{}\label{exr:unnamed-chunk-197}Let \(G\) and \(H\) be the following subgroups of \(GL_2 (\mathbb{R})\):
...
\protect\hypertarget{exr:unnamed-chunk-198}{}\label{exr:unnamed-chunk-198}Let \(S\) be a subset of a group \(G\) that contains the identity element 1, and such that the left cosets \(aS\), with \(a\) in \(G\), partition \(G\). Prove that \(S\) is a subgroup of \(G\).
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-201}{}\label{exr:unnamed-chunk-201}What are the possible values of \(a^2\) modulo 4? modulo 8?
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-202}{}\label{exr:unnamed-chunk-202}Prove that every integer \(a\) is congruent to the sum of its decimal digits modulo 9.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-205}{}\label{exr:unnamed-chunk-205}Solve the congruence \(2x \equiv 5\) modulo 9 and modulo 6.
\end{exercise}

\includegraphics{figures/ch_2/fig102.jpg}

\begin{exercise}[Artin 2.9.5]
\protect\hypertarget{exr:unnamed-chunk-207}{}\label{exr:unnamed-chunk-207}Determine the integers \(n\) for which the pair of congruences \(2x - y \equiv 1\) and \(4x + 3y \equiv 2\) modulo \(n\) has a solution.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-210}{}\label{exr:unnamed-chunk-210}Prove the Chinese Remainder Theorem: Let \(a, b, u, v\) be integers, and assume that the greatest common divisor of \(a\) and \(b\) is 1. Then there is an integer \(x\) such that \(x \equiv u\) modulo \(a\) and \(X \equiv v\) modulo \(b\).\\
Hint: Do the case \(u = 0\) and \(v = 1\) first.
\end{exercise}

\begin{exercise}[Artin 2.9.7]
\protect\hypertarget{exr:unnamed-chunk-211}{}\label{exr:unnamed-chunk-211}Determine the order of each of the matrices \(A=\begin{bmatrix}1 & 1 \\ 0 & 1\end{bmatrix}\) and \(B=\begin{bmatrix}1 & 1 \\ 1 & 0\end{bmatrix}\) when the matrix entries are interpreted modulo 3.
\end{exercise}
...
\protect\hypertarget{exr:unnamed-chunk-213}{}\label{exr:unnamed-chunk-213}Describe how to tell from the cycle decomposition whether a permutation is odd or even.
\end{exercise}

\begin{exercise}[Artin 2.10.2]
\protect\hypertarget{exr:unnamed-chunk-214}{}\label{exr:unnamed-chunk-214}Let H and K be subgroups of a group G.
...
\protect\hypertarget{exr:unnamed-chunk-215}{}\label{exr:unnamed-chunk-215}Let \(G\) and \(G'\) be cyclic groups of orders \(12\) and \(6\), generated by elements \(x\) and \(y\), respectively, and let \(\phi : G \to G'\) be the map defined by \(\phi(x^i) = y^i\). Exhibit the correspondence referred to in the Correspondence Theorem explicitly.
\end{exercise}

\begin{exercise}[Artin 2.10.4]
\protect\hypertarget{exr:unnamed-chunk-216}{}\label{exr:unnamed-chunk-216}With the notation of the Correspondence Theorem, let \(H\) and \(H'\) be corresponding subgroups. Prove that \[[G : H] = [G' : H']\].
\end{exercise}

\begin{exercise}[Artin 2.10.5]
\protect\hypertarget{exr:unnamed-chunk-217}{}\label{exr:unnamed-chunk-217}With reference to the homomorphism S4 -\textgreater{} S3 described in Example 2.5.13, determine the six subgroups of S4 that contain K.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-218}{}\label{exr:unnamed-chunk-218}Let \(x\) be an element of order \(r\) of a group \(G\), and let \(y\) be an element of \(G'\) of order \(s\). What is the order of \((x, y)\) in the product group \(G \times G'\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-219}{}\label{exr:unnamed-chunk-219}What does Proposition \ref{prp:prp2114} tell us when, with the usual notation for the symmetric
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-220}{}\label{exr:unnamed-chunk-220}Prove that the product of two infinite cyclic groups is not infinite cyclic.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-223}{}\label{exr:unnamed-chunk-223}Let \(G_1\) and \(G_2\) be groups, and let \(Z_i\) be the center of \(G_i\). Prove that the center of the product group \(G_1 \times G_2\) is \(Z_1 \times Z_2\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-224}{}\label{exr:unnamed-chunk-224}Let \(G\) be a group that contains normal subgroups of orders \(3\) and \(5\), respectively. Prove that \(G\) contains an element of order \(15\).
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-225}{}\label{exr:unnamed-chunk-225}Let \(H\) be a subgroup of a group \(G\), let \(\phi:G \to H\) be a homomorphism whose restriction to \(H\) is the identity map, and let \(N\) be its kernel. What can one say about the product map \(H \times N \to G\)?
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-226}{}\label{exr:unnamed-chunk-226}Let \(G\), \(G'\), and \(H\) be groups. Establish a bijective correspondence between homomorphisms \(\phi : H \to G \times G'\) from \(H\) to the product group and pairs \((\varphi, \varphi')\) consisting of a homomorphism \(\varphi:H \to G\) and a homomorphism \(\varphi':H \to G'\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-227}{}\label{exr:unnamed-chunk-227}Let \(H\) and \(K\) be subgroups of a group \(G\). Prove that the product set \(HK\) is a subgroup of \(G\) if and only if \(HK = KH\).
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-229}{}\label{exr:unnamed-chunk-229}Show that if a subgroup \(H\) of a group \(G\) is not normal, there are left cosets \(aH\) and \(bH\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-231}{}\label{exr:unnamed-chunk-231}In the general linear group \(GL_3(\mathbb{R})\), consider the subsets:
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-232}{}\label{exr:unnamed-chunk-232}Let \(P\) be a partition of a group \(G\) with the property that for any pair of elements \(A\), \(B\) of the partition, the product set \(AB\) is contained entirely within another element \(C\) of the partition. Let \(N\) be the element of \(P\) that contains 1. Prove that \(N\) is a normal subgroup of \(G\) and that \(P\) is the set of its cosets.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-234}{}\label{exr:unnamed-chunk-234}Let \(H = \{\pm1, \pm i\}\) be the subgroup of \(G = C^{\times}\) of fourth roots of unity. Describe the cosets of \(H\) in \(G\) explicitly. Is \(G / H\) isomorphic to \(G\)?
\end{exercise}
...
\begin{exercise}[M1]
\protect\hypertarget{exr:unnamed-chunk-236}{}\label{exr:unnamed-chunk-236}Describe the column vectors \((a, c)^T\) that occur as the first column of an integer matrix \(A\) whose inverse is also an integer matrix.
\end{exercise}
...
\begin{exercise}[M.2]
\protect\hypertarget{exr:unnamed-chunk-237}{}\label{exr:unnamed-chunk-237}\leavevmode
...
\protect\hypertarget{exr:unnamed-chunk-239}{}\label{exr:unnamed-chunk-239}(Double Cosets) Let \(H\) and \(K\) be subgroups of a group \(G\), and let \(g\) be an element of \(G\). \textbackslash{}
